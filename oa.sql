...
insert  into `power`(`powerId`,`powerName`) values (1,'发放工资'),(2,'查看日志'),(3,'添加用户'),(4,'添加日志'),(5,'修改权限'),(6,'修改日志'),(7,'审批流程'),(8,'查看流程');
...
insert  into `role`(`role_id`,`role_name`) values (0,'管理员'),(1,'用户');
...
insert  into `roletopower`(`roleId`,`powerId`) values (0,1),(0,2);
...
CREATE TABLE `user` (
  ...
  `userTel` varchar(11) DEFAULT NULL COMMENT '用户手机号',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `user` */

insert  into `user`(`user_id`,`user_name`,`user_count`,`password`,`create_time`,`userTel`) values (1,'admin','admin','123456','2024-04-24 14:43:01','13818248142'),(2,'zhangsan','fcfz135246','123456','2024-04-26 13:35:01','13458447552'),(3,'坤','jntm2.5','123456','2024-05-06 15:41:10','13462587305'),(7,'zds','zds13579','123456','2024-05-07 09:15:47','13570897076'),(8,'zds','zds13579','123456','2024-05-07 11:12:50','13570897076');
...
insert  into `usertorole`(`userId`,`roleId`) values (1,0),(2,1),(3,1),(4,1);
